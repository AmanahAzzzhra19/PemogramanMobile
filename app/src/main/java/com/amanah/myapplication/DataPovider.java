...
import com.amanah.myapplication.model.anjing;
import com.amanah.myapplication.model.hewan;
import com.amanah.myapplication.model.kucing;
import com.amanah.myapplication.model.sapi;
...
class DataProvider {
        ...
        private static List<sapi> iniDataRubah(Context ctx) {
            List<sapi> sapis = new ArrayList<>();
            sapis.add(new sapi("sapi Senepol", "Karibia",
                    "Sapi ini berambut pendek, dan diwarnai merah, hitam atau coklat", R.drawable.sapi_senepol));
            sapis.add(new sapi("Sapi Ongole", "India",
                    "Sapi ini tergolong jenis sapi zebu atau sapi berpunuk", R.drawable.sapi_ongole));
            sapis.add(new sapi("Sapi Boran", "Afrika",
                    "Sapi ini merupakan jenis sapi potong dengan kualitas daging yang baik", R.drawable.sapi_boran));
            sapis.add(new sapi("Sapi Braford", "Amerika Serikat",
                    "Braford memiliki ketahanan terhadap panas dan serangga", R.drawable.sapi_braford));
            sapis.add(new sapi("Sapi Aubrac", "Auvergne di Prancis Selatan",
                    "Aubrac adalah jenis ternak sapi prancis domestik", R.drawable.sapi_retinta));
